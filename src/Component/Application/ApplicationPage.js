          ...
          <Table sx={{ minWidth: 700, }} aria-label="customized table">
            <TableHead sx={{background: `linear-gradient(90deg, #0a0a0a, #1f272d, #1a237e, #283593, #1a237e)`}}>
              <TableRow >
                ...
                <StyledTableCell align="center">Compliance Type</StyledTableCell>
                <StyledTableCell align="center">Product Name</StyledTableCell>
                <StyledTableCell align="center">Model Number</StyledTableCell>
                <StyledTableCell align="center">Associated Number/Family Model</StyledTableCell>
                <StyledTableCell align="center">Start Date</StyledTableCell>
                <StyledTableCell align="center">Estimated Completion Date</StyledTableCell>
                <StyledTableCell align="center">ActualEnd Date</StyledTableCell>
            ...
            <TableBody>
              {Data.filter((item) => {
                ...
                <StyledTableRow key={row.name}>
                  ...
                  <StyledTableCell align="center" sx={{fontWeight:"bolder",color:"#1a237e"}}>{row.ComplianceType}</StyledTableCell>
                  ...
                  <StyledTableCell
                    ...
                    sx={{fontWeight:"bolder",color:"#1a237e",overflowX: 'auto',maxWidth: '150px'}}
                  >
                    {row.ModelNo}
                  </StyledTableCell>
                  <StyledTableCell align="center" sx={{fontWeight:"bolder",color:"#1a237e"}}>{row.AssociatedNumber}</StyledTableCell>
                  <StyledTableCell align="center" sx={{fontWeight:"bolder",color:"#1a237e"}}>
                    {row.StartDate}
                  </StyledTableCell>
                  <StyledTableCell align="center" sx={{fontWeight:"bolder",color:"#1a237e"}}>{row.EstimatedComplianceDate}</StyledTableCell>
                  <StyledTableCell align="center" sx={{fontWeight:"bolder",color:"#1a237e"}}>
                    {row.EndDate}
                  </StyledTableCell>
                  <StyledTableCell align="center" sx={{fontWeight:"bolder",color:"#1a237e"}}>
